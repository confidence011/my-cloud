...
const Homepage5 = () => {
    return (
        <div className='w-full text-whitemy-24'>
            <div className='w-full h-[800px] bg-slate-900 absolute mix-blend-overlay'>
                <div className='max-w-[1240px] mx-auto py-12'>
                    ...
                    <div className='text-center py-8 text-slate-300'>
                        ...
                        <p className='text-3xl'>Reimagined digital assest management (DAM) to meet the unique needs to today focusing on flexibility, intelligent automation, and scale.</p>
                    </div>
                    ...
                    <div className='grid md:grid-cols-3'>
                        ...
                        <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                            ...
                            <div>
                                <p className='text-6xl font-bold flex'>&#x20A6;6000 <span className='text-xl text-slate-500 flex flex-col justify-end'>/mo</span> </p>
                            </div>

                            <div>
                                <p className='text-xl py-8 text-0slate-500'> Extend your teams's degital madia compabilities for websites apps.</p>
                            </div>
                            ...
                            <div className='text-xl'>
                                <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> <AiOutlineCheck/> </span> Image and video transformation</p>
                            </div>
                            <div className='text-xl'>
                        ...
                        <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                            ...
                            <div>
                                <p className='text-6xl font-bold flex'>&#x20A6;12000 <span className='text-xl text-slate-500 flex flex-col justify-end'>/mo</span> </p>
                            </div>

                            <div>
                                <p className='text-xl py-8 text-0slate-500'> Deliver engaging visual experuences with advanced features and functionality.</p>
                            </div>
                            ...
                            <div className='text-xl'>
                                <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> <AiOutlineCheck/> </span> High performance delivery through CDN</p>
                        ...
                        <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                            ...
                            <div>
                                <p className='text-6xl font-bold flex'>&#x20A6;18000 <span className='text-xl text-slate-500 flex flex-col justify-end'>/mo</span> </p>
                            </div>
